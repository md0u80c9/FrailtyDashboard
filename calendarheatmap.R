...
calendarHeat <- function(dates, 
  ...
  #color styles
  greyhue <- c("#f7f7f7", "#cccccc", "#969696", "#525252")
  purplehue <- c("#f2f0f7", "#cbc9e2", "#9e9ac8", "#6a51a3")
  orangehue <- c("#feedde", "#fdbe85", "#fd8d3c", "d94701")
  redhue <- c("#fee5d9", "#fcae91", "#fb6a4a", "#cb181d")
  greenhue <- c("#edf8e9", "#bae4b3", "#74c476", "#238b45")
  bluehue <- c("#eff3ff", "#bdd7e7", "#6baed6", "#2171b5")
